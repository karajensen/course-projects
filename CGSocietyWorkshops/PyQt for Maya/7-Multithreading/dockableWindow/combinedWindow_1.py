...
def mayaRunDock():
    ...
    global dockControl
    try:
        if cmds.dockControl(dockControl, q=True, exists=True):
    ...
    dockControl = cmds.dockControl( area='right', content=windowObject, allowedArea=allowedAreas, label=windowTitle, w=350 )
